...
radar_significant_detection = 'significant_detection_mask'
radar_sweep_feature_size = 'radar_sweep_feature_size'

# Texture fields
differential_phase_texture = 'differential_phase_texture'

# Velocity retrieval fields
...
horizontal_wind_divergence = 'horizontal_wind_divergence'
hydrometeor_fall_speed = 'hydrometeor_fall_speed'

# Profile variables
height = 'height'
interpolated_profile = 'interpolated_profile'

# Rectilinear grid fields
nearest_neighbor_distance = 'nearest_neighbor_distance'
nearest_neighbor_weight = 'nearest_neighbor_weight'
nearest_neighbor_time = 'nearest_neighbor_time'
grid_quality_index = 'grid_quality_index'
...
DEFAULT_FIELD_NAMES = {
    ...
    'radar_estimated_rain_rate': radar_estimated_rain_rate,
    'radar_echo_classification': radar_echo_classification,
    'radar_significant_detection': radar_significant_detection,
    'radar_sweep_feature_size': radar_sweep_feature_size,
    'differential_phase_texture': differential_phase_texture,
    'eastward_wind_component': eastward_wind_component,
    'northward_wind_component': northward_wind_component,
...
DEFAULT_METADATA = {
    ...
    radar_significant_detection: {
        'units': 'unitless',
        'standard_name': 'radar_significant_detection',
        'long_name': 'Radar significant detection',
        'coordinates': 'elevation azimuth range',
        'valid_min': 0.0,
        'valid_max': 1.0,},

    radar_sweep_feature_size: {
        'units': 'unitless',
        'long_name': 'Size of radar features',
        'valid_min': 0,},
    ...
    wind_divergence: {
        'units': 'per_second',
        'long_name': 'Wind field divergence',},

    horizontal_wind_divergence: {
        'units': 'per_second',
        'long_name': 'Horizontal wind field divergence',},

    hydrometeor_fall_speed: {
        'units': 'meters_per_second',
        'long_name': 'Hydrometeor fall speed',
        'valid_min': 0.0,
        'positive': 'down',},
    ...
    nearest_neighbor_weight: {
        'units': 'unitless',
        'long_name': 'Nearest neighbor weight',
        'valid_min': 0.0,
        'valid_max': 1.0,},

    nearest_neighbor_time: {
        'long_name': 'Nearest neighbor time',
        'calendar': 'gregorian',},
